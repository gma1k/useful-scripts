...
# A function to perform a stealth nmap scan based on the IP address and CIDR notation
nmap_scan() {
  # Use nmap command with -sS option for stealth scan and -sV option for service version detection
...
# Perform a stealth nmap scan based on the IP address and CIDR notation
nmap_scan $ip $cidr
